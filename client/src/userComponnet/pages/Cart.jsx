    ...
    >
      ...
      <div className="pl-3">
        ...
        <div className="flex items-center">
          <p
            className={`text-red-700 font-medium ${new Date(item.product_id.offerId?.expiryDate) > new Date() ? 'line-through' : ''} mr-2`}
          >
    ...
    <>
      ...
      <div className="flex">
        ...
        >
          ...
          <div className="flex ">
            <div className="mr-10">{cartItem}</div>
            {cartproduct.length > 0 && price > 0 && (
              <div className="border-double border-4 border-gray-300 rounded-lg p-6 bg-white max-w-sm shadow-lg">
                ...
                <button
                  className="mt-6 w-full bg-emerald-700 text-white py-2 rounded-lg font-medium hover:bg-emerald-800 transition duration-200"
                  onClick={plceOrderHandle}
                >
                  Place Order
                </button>
              </div>
