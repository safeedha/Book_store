...
function Changepassword() {
  ...
  const handleSubmit = async(e) => {
    ...
    await changePassword(user._id,newPassword, setNewPassword, setConfirmPassword,toast)
      ...
      >
        <div className='max-w-md mx-auto'>
          <form className='space-y-6' onSubmit={handleSubmit}>
            <div>
              <label className='block text-red-950 font-semibold'>New Password:</label>
              <input
                type='password'
                value={newPassword}
            ...
            <div>
              <label className='block text-red-950 font-semibold'>Confirm Password:</label>
              <input
                type='password'
