...
function Wallet() {
   ...
   const transaction_history = wallet.map((item, index) => (
    ...
    >
      ...
      <div>
        <p className="text-lg">Amount:<span className='text-red-600'> &#8377;{item.amount}</span></p>
      </div>
    </div>
  ));
  ...
  return (
      ...
      <motion.div
         ...
         >
        {
          wallet.length===0&&(
            ...
            <h2 className="text-2xl font-semibold text-gray-800">Your Wallet is Empty</h2>
            <p className="text-gray-600">It looks like you haven’t added any funds yet. Start adding money to your wallet now!</p>
            <button
       ...
       <div className="flex flex-col items-center justify-center space-y-6">
        ...
        {wallet.length===0 && add && (
        <div className="flex flex-col items-center justify-center space-y-6">
          <form className="mt-4 flex flex-col items-center gap-4" onSubmit={addMoney}>
            <input
              type="number"
    ...
    <div className="bg-slate shadow-lg rounded-lg w-80 h-60 p-6 flex flex-col items-center justify-center">
      ...
      <p className="text-4xl font-semibold text-green-600">&#8377;{balence}</p>
    </div>
