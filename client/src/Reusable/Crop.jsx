...
import {imageUrlupdate,imageUrl2update,imageUrl3update,imageUrl4update} from '../feature/imageSlice'
...
const Crop = ({ url = null, url2 = null, url3 = null ,url4=null}) => {
  ...
  return (
    <div>
      ...
      <button type="button" onClick={generateCroppedImage} className="border border-indigo-600 bg-indigo-500 text-white rounded-full px-6 py-2 font-medium shadow-md hover:bg-indigo-600 hover:shadow-lg transition-all duration-200">
        Get Cropped Image</button>
    </div>
  );
};
