      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-1">
          <img src={LOGO} alt="Logo" className="h-10 w-10" />
             <span className="text-white text-2xl font-bold tracking-wide">BOOK LOOM</span>
        </div>
     <div>
        <input
        type="text"
      ...
      />
        ...
        <div className="flex items-center space-x-6">
          <Link to="/" className="text-white hover:text-blue-300 font-medium">Home</Link>
          <Link to="/#about" className="text-white hover:text-blue-300 font-medium">About</Link>
          {user ? (
          ...
          <Link to="/product" className="text-white hover:text-blue-300 font-medium">ProductList</Link>
