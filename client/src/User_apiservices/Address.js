...
export const addAddress=async( name, phone, streetAddress, state, district, pincode,city, setAddress,setAdd, toast,setFormData)=>{
  try{
      const response = await instance.post("/user/address", { name, phone, streetAddress, state, district, pincode,city});
...
export const getoneAddress= async(setFormData,id)=>{
 ...
 export const  updateAddress=async(id,toast,Navigate,name, phone, streetAddress, state, district, pincode,city)=>{
 try{
              const response = await instance.post(`/user/address/${id}`, { name, phone, streetAddress, state, district, pincode,city});
