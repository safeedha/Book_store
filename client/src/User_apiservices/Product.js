...
export  const fetchNewProduct = async () => {
    ...
    export const productInformation=async(id, setProductName, setDescription, setAuthor, setLanguage, setPrice, setStock, setOpt, set_Id, setSku, setImage, setActiveImage,toast,setOffer)=>{
      try{
