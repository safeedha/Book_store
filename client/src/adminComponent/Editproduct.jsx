...
useEffect(()=>{
 ...
 useEffect(() => {
  ...
  const handleSubmit = async(e) => {
      ...
      e.preventDefault();
       ...
       if(croped3)
        ...
        if(croped4)
          ...
          const response=await adminInstance.post(`/product/${id}`,{formatProductName,description,author,language,price,category,stock,sku,crop})
    ...
    catch(error)
    {
      ...
      if(error.response.data.meassage==="Product with this SKU already exists")
        {
 ...
 const handleFilechange2=(e)=>{
  ...
  <div class="flex-1 p-4 text-center">
    <img src={croped?croped:image[0]} alt="Image 1" class="w-full h-auto rounded-lg" />
    <input type="file" class="mt-2 p-2 border rounded-md w-full" onChange={handleFilechange} />
  </div>
  <div class="flex-1 p-4 text-center">
    <img src={croped2?croped2:image[1]} alt="Image 2" class="w-full h-auto rounded-lg" />
    <input type="file" class="mt-2 p-2 border rounded-md w-full" onChange={handleFilechange2}/>
  </div>
  <div class="flex-1 p-4 text-center">
    <img src={croped3?croped3:image[2]} alt="Image 3" class="w-full h-auto rounded-lg" />
    <input type="file" class="mt-2 p-2 border rounded-md w-full" onChange={handleFilechange3} />
  </div>
  <div class="flex-1 p-4 text-center">
    <img src={croped4?croped4:image[3]} alt="Image 4" class="w-full h-auto rounded-lg" />
    <input type="file" class="mt-2 p-2 border rounded-md w-full" onChange={handleFilechange4}/>
  </div>
</div>
