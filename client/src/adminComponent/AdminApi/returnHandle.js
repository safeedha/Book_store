...
export const approveProduct = async (orderid, productid,userid,toast,setActive) => {
  try {
  ...
  if(response){
    toast.success("Product return processed successfully. The refund has been credited to the customer's wallet.")
...
export const rejectProduct=async(orderid, productid,userid,toast,setActive)=>
{
  try {
