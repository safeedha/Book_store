...
user_routes.get('/orders/:orderid/product/:productId',verifyUsertoken,order.getSingleOrderdetail)
user_routes.get('/orders/:orderid/:productId',verifyUsertoken,order.relatedProduct)
user_routes.post('/return/:orderid/product/:productId',verifyUsertoken,retoorn.returnProduct)
...
user_routes.get('/wishlist/:productId',verifyUsertoken, wish.getWishListstatus)
